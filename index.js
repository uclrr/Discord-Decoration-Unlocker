...
╚███╔███╔╝██║╚██████╗██║  ██╗    ███████║   ██║   ╚██████╔╝██████╔╝██║╚██████╔╝
 ╚══╝╚══╝ ╚═╝ ╚═════╝╚═╝  ╚═╝    ╚══════╝   ╚═╝    ╚═════╝ ╚═════╝ ╚═╝ ╚═════╝ 
Copyright (c) 2025 CLAIRE | discord.gg/claire
*/
        ...
        try {
          const helpEmbed = new EmbedBuilder()
            ...
            .addFields([
              ...
              { 
                name: '🔗 Links', 
                value: '[Support Server](https://discord.gg/claire) | [GitHub](https://github.com/wickstudio/discord-avatar-decoration-bot)'
              }
            ])
            .setFooter({ text: 'Made with ❤️ by CLAIRE • ' + new Date().toLocaleDateString() });
